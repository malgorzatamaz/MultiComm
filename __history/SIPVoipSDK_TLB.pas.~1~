...
// $Rev: 52393 $
// File generated on 18.10.2015 12:02:16 from Type Library described below.

// ************************************************************************  //
// Type Lib: C:\Program Files (x86)\ABTO Software\VoIP Video SIP SDK\binary\SIPVoIPSDK.dll (1)
...
// SYS_KIND: SYS_WIN32
// Errors:
//   Hint: Parameter 'type' of _IAbtoPhoneEvents.OnToneDetected changed to 'type_'
//   Error creating palette bitmap of (TCConfig) : Server C:\Program Files (x86)\ABTO Software\VoIP Video SIP SDK\binary\SIPVoIPSDK.dll contains no icons
//   Error creating palette bitmap of (TCSubscriptions) : Server C:\Program Files (x86)\ABTO Software\VoIP Video SIP SDK\binary\SIPVoIPSDK.dll contains no icons
//   Error creating palette bitmap of (TCAbtoPhone) : Server C:\Program Files (x86)\ABTO Software\VoIP Video SIP SDK\binary\SIPVoIPSDK.dll contains no icons
// ************************************************************************ //
...
// *********************************************************************//
  IConfig = interface(IDispatch)
    ...
    procedure Set_LocalVideoWindow(hVideoWindow: Integer); safecall;
    function Get_LocalVideoWindow: Integer; safecall;
    procedure Set_RemoteVideoWindow(hVideoWindow: Integer); safecall;
    function Get_RemoteVideoWindow: Integer; safecall;
    ...
    procedure Set_SignallingTransport(transp: TransportType); safecall;
    function Get_SignallingTransport: TransportType; safecall;
    ...
    procedure RemoteVideoWindow_Get(wndIdx: Integer; var hVideoWnd: Integer); safecall;
    procedure RemoteVideoWindow_Set(wndIdx: Integer; hVideoWnd: Integer); safecall;
    procedure RemoteVideoWindow_Add(hVideoWnd: Integer); safecall;
    ...
    property LocalVideoWindow: Integer read Get_LocalVideoWindow write Set_LocalVideoWindow;
    property RemoteVideoWindow: Integer read Get_RemoteVideoWindow write Set_RemoteVideoWindow;
    ...
    property SignallingTransport: TransportType read Get_SignallingTransport write Set_SignallingTransport;
...
// *********************************************************************//
  IConfigDisp = dispinterface
    ...
    property LocalVideoWindow: Integer dispid 252;
    property RemoteVideoWindow: Integer dispid 253;
    ...
    property SignallingTransport: TransportType dispid 274;
    ...
    procedure RemoteVideoWindow_Get(wndIdx: Integer; var hVideoWnd: Integer); dispid 13;
    procedure RemoteVideoWindow_Set(wndIdx: Integer; hVideoWnd: Integer); dispid 14;
    procedure RemoteVideoWindow_Add(hVideoWnd: Integer); dispid 15;
...
// *********************************************************************//
  _IAbtoPhoneEvents = dispinterface
    ...
    function OnInitialized(const Msg: WideString): HResult; dispid 1;
    function OnLineSwiched(LineId: Integer): HResult; dispid 2;
    function OnEstablishedConnection(const AddrFrom: WideString; const AddrTo: WideString; 
                                     ConnectionId: Integer; LineId: Integer): HResult; dispid 3;
    function OnClearedConnection(ConnectionId: Integer; LineId: Integer): HResult; dispid 4;
    function OnIncomingCall(const AddrFrom: WideString; LineId: Integer): HResult; dispid 5;
    function OnEstablishedCall(const Msg: WideString; LineId: Integer): HResult; dispid 6;
    function OnClearedCall(const Msg: WideString; status: Integer; LineId: Integer): HResult; dispid 7;
    function OnVolumeUpdated(IsMicrophone: Integer; level: Integer): HResult; dispid 8;
    function OnRegistered(const Msg: WideString): HResult; dispid 9;
    function OnUnRegistered(const Msg: WideString): HResult; dispid 10;
    function OnPlayFinished(const Msg: WideString): HResult; dispid 11;
    function OnToneReceived(Tone: Integer; ConnectionId: Integer; LineId: Integer): HResult; dispid 12;
    function OnTextMessageReceived(const address: WideString; const message: WideString): HResult; dispid 13;
    function OnPhoneNotify(const Msg: WideString): HResult; dispid 14;
    function OnRemoteAlerting(ConnectionId: Integer; responseCode: Integer; 
                              const reasonMsg: WideString): HResult; dispid 15;
    function OnHoldCall(LineId: Integer; isHeld: Integer): HResult; dispid 16;
    function OnTextMessageSentStatus(const address: WideString; const reason: WideString; 
                                     bSuccess: Integer): HResult; dispid 17;
    function OnRecordFinished(const Msg: WideString): HResult; dispid 18;
    function OnSubscribeStatus(subscriptionId: Integer; statusCode: Integer; 
                               const statusMsg: WideString): HResult; dispid 19;
    function OnUnSubscribeStatus(subscriptionId: Integer; statusCode: Integer; 
                                 const statusMsg: WideString): HResult; dispid 20;
    function OnSubscriptionRequest(const fromUri: WideString; const eventStr: WideString): HResult; dispid 21;
    function OnSubscriptionNotify(subscriptionId: Integer; const StateStr: WideString; 
                                  const NotifyStr: WideString): HResult; dispid 22;
    function OnDetectedAnswerTime(TimeSpanMs: Integer; ConnectionId: Integer): HResult; dispid 23;
    function OnBaudotToneReceived(Tone: Integer; ConnectionId: Integer; LineId: Integer): HResult; dispid 24;
    function OnSubscriptionTerminated(const fromUri: WideString): HResult; dispid 25;
    function OnToneDetected(type_: ToneType; const ToneStr: WideString; ConnectionId: Integer; 
                            LineId: Integer): HResult; dispid 26;
    function OnReceivedSipNotifyMsg(const SipNotifyMsgStr: WideString): HResult; dispid 27;
    function OnPlayFinished2(const Msg: WideString; LineId: Integer): HResult; dispid 28;
    function OnRemoteAlerting2(ConnectionId: Integer; LineId: Integer; responseCode: Integer; 
                               const reasonMsg: WideString): HResult; dispid 29;
    function OnReceivedRequestInfo(ConnectionId: Integer; LineId: Integer; 
                                   const contentType: WideString; const body: WideString): HResult; dispid 30;
    function OnBaudotFinished(const Msg: WideString; LineId: Integer): HResult; dispid 31;
  end;
...
// *********************************************************************//
  IAbtoPhone = interface(IDispatch)
    ...
    procedure AssignVideoWindow(ConnectionId: Integer; hVideoWindow: Integer); safecall;
...
// *********************************************************************//
  IAbtoPhoneDisp = dispinterface
    ...
    procedure PlayBuffer(bufferPtr: Int64; size: Integer; rate: Integer); dispid 29;
    procedure StartRecordingBuffer(bufferPtr: Int64; size: Integer); dispid 30;
    ...
    procedure StartRecordingConnectionBuffer(ConnectionId: Integer; bufferPtr: Int64; size: Integer); dispid 52;
    ...
    procedure AssignVideoWindow(ConnectionId: Integer; hVideoWindow: Integer); dispid 68;
...
// *********************************************************************//
  ...
  protected
    ...
    procedure Set_LocalVideoWindow(hVideoWindow: Integer);
    function Get_LocalVideoWindow: Integer;
    procedure Set_RemoteVideoWindow(hVideoWindow: Integer);
    function Get_RemoteVideoWindow: Integer;
    ...
    procedure Set_SignallingTransport(transp: TransportType);
    function Get_SignallingTransport: TransportType;
  ...
  public
    ...
    procedure RemoteVideoWindow_Get(wndIdx: Integer; var hVideoWnd: Integer);
    procedure RemoteVideoWindow_Set(wndIdx: Integer; hVideoWnd: Integer);
    procedure RemoteVideoWindow_Add(hVideoWnd: Integer);
...
// *********************************************************************//
  ...
  TCAbtoPhoneOnToneDetected = procedure(ASender: TObject; type_: ToneType; 
...
// *********************************************************************//
  ...
  public
    ...
    procedure AssignVideoWindow(ConnectionId: Integer; hVideoWindow: Integer);
...
begin
  DefaultInterface.StunServer := StunAddress;
end;
...
begin
  DefaultInterface.ListenPort := Port;
end;
...
begin
  DefaultInterface.RtpStartPort := Port;
end;
...
begin
  DefaultInterface.ActivePlaybackDevice := DeviceName;
end;
...
begin
  DefaultInterface.ActiveRecordDevice := DeviceName;
end;
...
begin
  DefaultInterface.MinJitterDelay := Delay;
end;
...
begin
  DefaultInterface.MaxJitterDelay := Delay;
end;
...
begin
  DefaultInterface.SoundBufferDepth := Depth;
end;
...
begin
  DefaultInterface.EchoCancelationEnabled := Enabled;
end;
...
begin
  DefaultInterface.SilenceDetectionEnabled := Enabled;
end;
...
begin
  DefaultInterface.AutoGainControlEnabled := Enabled;
end;
...
begin
  DefaultInterface.NoiseReductionEnabled := Enabled;
end;
...
begin
  DefaultInterface.UserAgent := AgentName;
end;
...
begin
  DefaultInterface.RegDomain := Domain;
end;
...
begin
  DefaultInterface.RegAuthId := AuthId;
end;
...
begin
  DefaultInterface.RegExpire := Expire;
end;
...
begin
  DefaultInterface.ProxyDomain := Domain;
end;
...
begin
  DefaultInterface.ProxyUser := User;
end;
...
begin
  DefaultInterface.ProxyPass := Pass;
end;
...
begin
  DefaultInterface.LicenseUserId := UserId;
end;
...
begin
  DefaultInterface.LicenseKey := Key;
end;
...
begin
  DefaultInterface.SamplesPerSecond := Samples;
end;
...
begin
  DefaultInterface.ActiveNetworkInterface := DeviceName;
end;
...
begin
  DefaultInterface.DialToneEnabled := Enabled;
end;
...
begin
  DefaultInterface.VolumeUpdateSubscribed := Enabled;
end;
...
begin
  DefaultInterface.LogLevel := level;
end;
...
begin
  DefaultInterface.AdditionalDnsServer := dnsServerIPAddress;
end;
...
begin
  DefaultInterface.AdditionalSDPContent := sdpContent;
end;
...
begin
  DefaultInterface.AutoAnswerEnabled := Enabled;
end;
...
begin
  DefaultInterface.MP3RecordingEnabled := Enabled;
end;
...
begin
  DefaultInterface.LocalAudioEnabled := Enabled;
end;
...
procedure TCConfig.Set_LocalVideoWindow(hVideoWindow: Integer);
begin
  DefaultInterface.LocalVideoWindow := hVideoWindow;
end;

function TCConfig.Get_LocalVideoWindow: Integer;
begin
  Result := DefaultInterface.LocalVideoWindow;
end;

procedure TCConfig.Set_RemoteVideoWindow(hVideoWindow: Integer);
begin
  DefaultInterface.RemoteVideoWindow := hVideoWindow;
end;

function TCConfig.Get_RemoteVideoWindow: Integer;
begin
...
begin
  DefaultInterface.RingToneEnabled := Enabled;
end;
...
begin
  DefaultInterface.ActiveVideoDevice := DeviceName;
end;
...
begin
  DefaultInterface.VideoCallEnabled := Enabled;
end;
...
begin
  DefaultInterface.LocalTonesEnabled := Enabled;
end;
...
begin
  DefaultInterface.CallInviteTimeout := sec;
end;
...
begin
  DefaultInterface.EncryptedCallEnabled := Enabled;
end;
...
begin
  DefaultInterface.MixerFilePlayerEnabled := Enabled;
end;
...
begin
  DefaultInterface.RegRealm := Domain;
end;
...
begin
  DefaultInterface.KeepAliveTimeSIP := seconds;
end;
...
begin
  DefaultInterface.KeepAliveTimeRTP := seconds;
end;
...
begin
  DefaultInterface.ICEEnabled := Enabled;
end;
...
begin
  DefaultInterface.DtmfAsSipInfoEnabled := Enabled;
end;
...
begin
  DefaultInterface.RingToneFile := wavFile;
end;
...
begin
  DefaultInterface.LogPath := logFilePath;
end;
...
begin
  DefaultInterface.VideoFrameWidth := Width;
end;
...
begin
  DefaultInterface.VideoFrameHeight := Height;
end;
...
begin
  DefaultInterface.SDPInRingingMsgEnabled := Enabled;
end;
...
procedure TCConfig.Set_SignallingTransport(transp: TransportType);
begin
  DefaultInterface.SignallingTransport := transp;
end;

function TCConfig.Get_SignallingTransport: TransportType;
begin
...
begin
  DefaultInterface.LoopbackNetworkInterfaceEnabled := Enabled;
end;
...
begin
  DefaultInterface.FixedTransportInterfaceEnabled := Enabled;
end;
...
begin
  DefaultInterface.ComfortNoiseOnMutedMicEnabled := Enabled;
end;
...
begin
  DefaultInterface.ProvisionalMode := mode;
end;
...
begin
  DefaultInterface.SendRingingMsgEnabled := Enabled;
end;
...
begin
  DefaultInterface.TonesTypesToDetect := types;
end;
...
begin
  DefaultInterface.AudioQosDscpVal := val;
end;
...
begin
  DefaultInterface.VideoQosDscpVal := val;
end;
...
begin
  DefaultInterface.AudioSSRCVal := val;
end;
...
begin
  DefaultInterface.VideoSSRCVal := val;
end;
...
begin
  DefaultInterface.TonesBaudRate := rate;
end;
...
begin
  DefaultInterface.OverrideRtpDest := dest;
end;
...
begin
  DefaultInterface.AECDelayMs := ms;
end;
...
begin
  DefaultInterface.DmpCreateEnabled := Enabled;
end;
...
begin
  DefaultInterface.VideoAutoSendEnabled := Enabled;
end;
...
begin
  DefaultInterface.ProxyForceForAllRequests := Enabled;
end;
...
procedure TCConfig.RemoteVideoWindow_Get(wndIdx: Integer; var hVideoWnd: Integer);
begin
  DefaultInterface.RemoteVideoWindow_Get(wndIdx, hVideoWnd);
end;

procedure TCConfig.RemoteVideoWindow_Set(wndIdx: Integer; hVideoWnd: Integer);
begin
  DefaultInterface.RemoteVideoWindow_Set(wndIdx, hVideoWnd);
end;

procedure TCConfig.RemoteVideoWindow_Add(hVideoWnd: Integer);
begin
...
begin
  DefaultInterface.PlaybackVolume := level;
end;
...
begin
  DefaultInterface.PlaybackMuted := Muted;
end;
...
begin
  DefaultInterface.RecordVolume := level;
end;
...
begin
  DefaultInterface.RecordMuted := Muted;
end;
...
procedure TCAbtoPhone.AssignVideoWindow(ConnectionId: Integer; hVideoWindow: Integer);
begin
